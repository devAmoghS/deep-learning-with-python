...
dropout_loss, dropout_val_loss, dropout_acc, dropout_val_acc = get_losses(get_dropout_model())


epochs = range(1, len(original_loss) + 1)

plt.plot(epochs, original_loss, 'r', label='Original model')
plt.plot(epochs, dropout_loss, 'b', label='Dropout model')
plt.xlabel('Epochs')
...
plt.plot(epochs, dropout_val_loss, 'b', label='Dropout model')
plt.xlabel('Epochs')
...
plt.plot(epochs, dropout_acc, 'b', label='Dropout model')
plt.xlabel('Epochs')
...
plt.plot(epochs, dropout_val_acc, 'b', label='Dropout model')
plt.xlabel('Epochs')
